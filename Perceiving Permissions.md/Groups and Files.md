...
### Solve
**Flag:** pwn.college{oiEqCJlZl5MnMwapZVhbYrLHHsP.QXxcjM1wiNxIzNzEzW}

change grp using chgrp from root to hacker for /flag then read using cat /flag.

```bash
hacker@permissions~groups-and-files:~$ chgrp hacker /flag
hacker@permissions~groups-and-files:~$ cat /flag
pwn.college{oiEqCJlZl5MnMwapZVhbYrLHHsP.QXxcjM1wiNxIzNzEzW}
```

### New Learnings
change grp using chgrp from root to hacker for /flag
### References 
N.A.
