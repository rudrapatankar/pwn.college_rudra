...
### Solve
**Flag:** `pwn.college{8pibya2RgsTiZ6L-IEjcNJ2MZkO.QX3YTN0wiNxIzNzEzW}`

store the output in myflag file and errors in instructions file
...
pwn.college{8pibya2RgsTiZ6L-IEjcNJ2MZkO.QX3YTN0wiNxIzNzEzW}
```

### New Learnings
1> for storing output 2> storing error 0> storing input
