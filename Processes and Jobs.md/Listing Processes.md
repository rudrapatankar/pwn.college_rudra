...
### Solve
**Flag:** pwn.college{U8dNdYlnULweMIEz8qNRg0FZNRo.QX4MDO0wiNxIzNzEzW}

As the renamed flag file is stored in challenge directory. Listing the processes running we get the /challenge/10638-run-12653 running it gives flag

```bash
hacker@processes~listing-processes:~$ ps aux
USER         PID %CPU %MEM    VSZ   RSS TTY      STAT START   TIME COMMAND
root           1  0.0  0.0   1056   640 ?        Ss   05:57   0:00 /sbin/docker-init -- /nix/var/nix/profiles/dojo-works
root           7  0.0  0.0 231708  2560 ?        S    05:57   0:00 /run/dojo/bin/sleep 6h
root         132  0.0  0.0   4132  2560 ?        S    05:57   0:00 /challenge/10638-run-12653
root         135  0.0  0.0   2744  1600 ?        S    05:57   0:00 sleep 6h
hacker       137  0.1  0.0 231576  3520 pts/0    Ss   05:57   0:00 /nix/store/0nxvi9r5ymdlr2p24rjj9qzyms72zld1-bash-inte
hacker       143  0.0  0.0 231940  4160 pts/0    S    05:57   0:00 /run/dojo/bin/bash --login
hacker       152  0.0  0.0 233600  3840 pts/0    R+   05:58   0:00 ps aux
hacker@processes~listing-processes:~$ /challenge/10638-run-12653
Yahaha, you found me! Here is your flag:
pwn.college{U8dNdYlnULweMIEz8qNRg0FZNRo.QX4MDO0wiNxIzNzEzW}
```

### New Learnings
ps aux and ps -ef is used to list processes running and also other specific details
